        ...
        <p>
            ...
            successful undergraduate program in Information Technology at VNRVJIET Hyderabad, India.
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className=" mb-5 justify-content-center align-items-center flex-md-row flex-column" id="pills-tab">
                    <Nav.Item>
                      <Nav.Link eventKey="first">Work Exposure</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
